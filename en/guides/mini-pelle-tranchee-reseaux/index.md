# Digging a service trench with a mini excavator

> How to dig a trench with a mini excavator: bucket width, depth by utility (water, power, drainage), recommended weight and safety. A CZN Machinery guide.
...
Water supply, power connection, drainage or fibre: digging a clean, even trench is one of the most common jobs for a mini excavator. Here's how to pick the right bucket, the right weight and work safely.
...
For a homeowner or tradesperson opening occasional trenches around a house, a 1.8 to 2.5-tonne machine is the best compromise between power, size and transport. If you're unsure about the range, our guide ["How to choose your mini excavator"](/en/guides/comment-choisir-mini-pelle/) details each criterion. You'll also find a selection of suitable models on the [mini excavators](/en/mini-pelles/) page.
...
Most mini excavators ship with several buckets, and changing takes a few minutes, especially with a quick-hitch. Discover the buckets and hitches available on the [attachments](/en/accessoires/) page.
...
[See the attachments →](/en/accessoires/)
...
To improve your operating and boom control, see our guides [using a mini excavator](/en/guides/utilisation-mini-pelle/) and [earthworks with a mini excavator](/en/guides/mini-pelle-terrassement/).
...
On training, operating a mini excavator in a professional setting requires an authorisation to operate issued by the employer, generally based on the CACES R482 category A in France. For strictly private use on your own land, the CACES isn't compulsory, but training is still strongly recommended. Our guide [CACES mini excavator](/en/guides/caces-mini-pelle/) details these obligations.

## Budget and CZN solutions
Two options are open to you: rent or buy. Renting makes sense for a one-off job of a few days; beyond that, buying quickly pays off, especially if you multiply earthmoving and trenching jobs. Our comparison [buy or rent a mini excavator](/en/guides/mini-pelle-acheter-ou-louer/) helps you decide, and the guide [mini excavator rental](/en/guides/location-mini-pelle/) gives the cost benchmarks.
At CZN Machinery, a direct importer based in Toulouse, new mini excavators start from €4,125 excl. VAT , a price made possible by importing without a middleman. Every machine comes with a 2-year warranty , France-based aftersales, delivery across France and financing available via [Sofinco](/en/entreprise/financement/). The machines are fitted as standard with Laidong engines (Kubota available to order): to compare, see our guide [Laidong or Kubota](/en/guides/moteur-laidong-ou-kubota-mini-pelle/).
If your budget is tight, the [used](/en/occasion/) range offers machines inspected on 50 points and covered by a 6-month warranty. And for a first look at market prices, see our guide [mini excavator prices](/en/guides/prix-mini-pelle/).
...
- [Why a mini excavator for a trench](#pourquoi-mini-pelle)

- [What weight for the depth](#tonnage-conseille)

- [The trenching bucket: width & choice](#godet-tranchee)

- [Depths and widths by utility](#profondeurs-reseaux)

- [Steps to dig cleanly](#etapes-creuser)

- [Safety and regulations](#securite-reglementation)

- [Budget and CZN solutions](#budget-czn)

Further reading

## Related articles.

[Uses Earthworks with a mini excavator Techniques and methods for your compact earthmoving jobs.](/en/guides/mini-pelle-terrassement/)
[Uses Using your mini excavator well Getting started, operating and day-to-day best practice.](/en/guides/utilisation-mini-pelle/)
[Buying How to choose your mini excavator Weight, buckets and criteria for the right model.](/en/guides/comment-choisir-mini-pelle/)

## Rent or buy: let's do the maths?

Our team compares the cost of renting against buying based on your real use. Free quote, no obligation.
